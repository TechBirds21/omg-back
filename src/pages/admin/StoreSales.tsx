      ...
      <Tabs defaultValue="analytics" className="space-y-4">
        ...
        <TabsContent value="reports" className="space-y-4">
          <Card>
            ...
            <CardContent>
              {salesReport && salesReport.bills && salesReport.bills.length > 0 ? (
                <>
                  <div className="overflow-x-auto">
                    <table className="min-w-full">
                      <thead>
                      ...
                      <tbody>
                        {salesReport.bills.map((bill: any) => (
                          <tr key={bill.id} className="border-b hover:bg-muted/50">
                            <td className="p-3 font-mono">{bill.bill_number || 'N/A'}</td>
                            <td className="p-3">
                              <div>
                                <div className="font-medium">{bill.customer_name || 'N/A'}</div>
                                {bill.customer_phone && (
                            ...
                            <td className="p-3 capitalize">{bill.payment_method || 'Cash'}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
