  ...
  useEffect(() => {
    ...
    const initializeInstance = async () => {
      try {
        ...
        if (!accountId || !apiKey) {
          setError('ZohoPay configuration missing. Please configure Account ID and Access Token in Admin Settings → Payment Gateways → ZohoPay. Click on the ZohoPay gateway card and use the "Credentials" tab to enter your Account ID and Access Token, then click "Save Configuration".');
          return;
        }
          ...
          <AlertDescription className="text-red-900 font-medium">
            <div className="space-y-2">
              ...
              <div className="mt-3 p-3 bg-white border border-red-200 rounded-md">
                <p className="text-sm font-semibold text-gray-900 mb-2">Configuration Steps:</p>
                <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
                  <li>Navigate to <strong>Admin Settings</strong> page</li>
                  <li>Go to <strong>Payment Gateways</strong> tab</li>
                  <li>Find the <strong>ZohoPay</strong> gateway card</li>
                  <li>Click on the card to expand configuration</li>
                  <li>Enter your <strong>Account ID</strong> and <strong>Access Token</strong> in the Credentials tab</li>
